...
namespace Editor.Scenes.PartieConfiguration
{
    ...
    public class Noble : Node2D
    {
        ...
        public void SetValues(StartScreen.Noble n)
        {
            _maxHP = n.maxHP;
            _maxAP = n.maxAP;
            _maxMP = n.maxMP;
            ...
            _inventorySizeEdit.Text = _inventorySize.ToString();
            _healingHPEdit.Text = _healingHP.ToString(CultureInfo.InvariantCulture);
        ...
        public StartScreen.Noble getNoble()
        {
            StartScreen.Noble noble= new StartScreen.Noble();
            noble.damage = _damage;
            noble.healingHP = _healingHP;
            noble.maxAP = _maxAP;
            noble.maxHP = _maxHP;
            noble.maxMP = _maxMP;
            noble.inventorySize = _inventorySize;
            return noble;
        }
    }
}
