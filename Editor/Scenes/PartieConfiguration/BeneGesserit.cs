...
namespace Editor.Scenes.PartieConfiguration
{
     ...
     */
    public class BeneGesserit : Node2D
    {
        ...
        public void SetValues(StartScreen.BeneGesserit n)
        {
            _maxHP = n.maxHP;
            _maxAP = n.maxAP;
            _maxMP = n.maxMP;
        ...
        public StartScreen.BeneGesserit getBeneGesserit()
        {
            StartScreen.BeneGesserit beneGesserit= new StartScreen.BeneGesserit();
            beneGesserit.damage = _damage;
            beneGesserit.healingHP = _healingHP;
            beneGesserit.maxAP = _maxAP;
            beneGesserit.maxHP = _maxHP;
            beneGesserit.maxMP = _maxMP;
            beneGesserit.inventorySize = _inventorySize;
            return beneGesserit;
        }
    }
}
