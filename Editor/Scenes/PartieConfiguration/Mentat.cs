...
namespace Editor.Scenes.PartieConfiguration
{
    ...
    public class Mentat : Node2D
    {
        ...
        public void SetValues(StartScreen.Mentat n)
        {
            _maxHP = n.maxHP;
            _maxAP = n.maxAP;
            _maxMP = n.maxMP;
        ...
        public StartScreen.Mentat getMentat()
        {
            StartScreen.Mentat mentat= new StartScreen.Mentat();
            mentat.damage = _damage;
            mentat.healingHP = _healingHP;
            mentat.maxAP = _maxAP;
            mentat.maxHP = _maxHP;
            mentat.maxMP = _maxMP;
            mentat.inventorySize = _inventorySize;
            return mentat;
        }
    }
}
